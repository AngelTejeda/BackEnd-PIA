...
namespace API_Rest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Se permite el origen localhost:8100.
            // En el header pueden aparecer las llaves "Authorization" y "Content-Type".
            // Los métodos permitidos son GET, POST, PUT y DELETE.
            services.AddCors(cors => cors.AddPolicy("CustomCors", permisions =>
            {
                permisions
